...
```tsx
import { usePlatformAgentsGet } from "@gleanwork/api-client/react-query/platformAgentsGet.js";

export function Example() {
  const { data, error, status } = usePlatformAgentsGet("<id>");
...
export function ExampleWithOptions() {
  ...
  const { data, error, status } = usePlatformAgentsGet(
    "<id>",
    {
...
```tsx
import { usePlatformAgentsSearchMutation } from "@gleanwork/api-client/react-query/platformAgentsSearch.js";

export function Example() {
  const { mutate, status } = usePlatformAgentsSearchMutation();
...
import { invalidatePlatformAgentsGet, invalidateAllPlatformAgentsGet } from "@gleanwork/api-client/react-query/platformAgentsGet.js";
      ...
      onSubmit={(e) => {
        ...
        mutate(formData, {
          onSuccess: () => {
            ...
            invalidatePlatformAgentsGet(queryClient, /* ... arguments ... */);
            // OR, invalidate all cache entries for the query targets:
            invalidateAllPlatformAgentsGet(queryClient);
          },
        });
      }}
    >
...
import { GleanCore } from "@gleanwork/api-client";
import { GleanProvider } from "@gleanwork/api-client/react-query";
import { usePlatformAgentsGetSuspense } from "@gleanwork/api-client/react-query/platformAgentsGet.js";
...
function Example() {
  const { data } = usePlatformAgentsGetSuspense("<id>");
...
import { GleanCore } from "@gleanwork/api-client";
import { prefetchPlatformAgentsGet } from "@gleanwork/api-client/react-query/platformAgentsGet.js";
...
export default async function Page() {
  ...
  await prefetchPlatformAgentsGet(queryClient, glean, "<id>");
