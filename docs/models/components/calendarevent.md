...
| `isOrganizer`                                                                                | *boolean*                                                                                    | :heavy_minus_sign:                                                                           | Whether the requesting user is the organizer of this event.                                  |
| `roomBookingStatus`                                                                          | [components.CalendarRoomBookingStatus](../../models/components/calendarroombookingstatus.md) | :heavy_minus_sign:                                                                           | The current booking status of the room resource associated with an event.                    |
| `roomName`                                                                                   | *string*                                                                                     | :heavy_minus_sign:                                                                           | The display name of the room resource associated with this event.                            |
