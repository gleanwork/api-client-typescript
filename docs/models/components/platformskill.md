...
let value: PlatformSkill = {
  id: "<id>",
  displayName: "Jerome_Kutch",
  description: "afore joyously insidious daily bog coop haze meh pointless",
  latestVersion: 325433,
  latestMinorVersion: 984891,
  status: "DRAFT",
  origin: "CUSTOM",
  owner: {
    name: "<value>",
  },
  createdAt: new Date("2024-01-07T19:53:38.172Z"),
  updatedAt: new Date("2026-08-25T04:34:11.776Z"),
};
```
