...
import { platformAgentsSearch } from "@gleanwork/api-client/funcs/platformAgentsSearch.js";
...
async function run() {
  const res = await platformAgentsSearch(glean, {
    name: "HR Policy Agent",
  });
  if (res.ok) {
    ...
    console.log("platformAgentsSearch failed:", res.error);
  }
}
...
import {
  ...
  usePlatformAgentsSearchMutation
} from "@gleanwork/api-client/react-query/platformAgentsSearch.js";
```
...
```typescript
import { GleanCore } from "@gleanwork/api-client/core.js";
import { platformAgentsGet } from "@gleanwork/api-client/funcs/platformAgentsGet.js";
...
async function run() {
  const res = await platformAgentsGet(glean, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("platformAgentsGet failed:", res.error);
  }
}
...
import {
  ...
  usePlatformAgentsGet,
  usePlatformAgentsGetSuspense,
  ...
  invalidatePlatformAgentsGet,
  invalidateAllPlatformAgentsGet,
} from "@gleanwork/api-client/react-query/platformAgentsGet.js";
```
...
```typescript
import { GleanCore } from "@gleanwork/api-client/core.js";
import { platformAgentsGetSchemas } from "@gleanwork/api-client/funcs/platformAgentsGetSchemas.js";
...
async function run() {
  const res = await platformAgentsGetSchemas(glean, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("platformAgentsGetSchemas failed:", res.error);
  }
}
...
import {
  // Query hooks for fetching data.
  usePlatformAgentsGetSchemas,
  usePlatformAgentsGetSchemasSuspense,
  ...
  // Utilities to invalidate the query cache for this query in response to
  // mutations and other user actions.
  invalidatePlatformAgentsGetSchemas,
  invalidateAllPlatformAgentsGetSchemas,
} from "@gleanwork/api-client/react-query/platformAgentsGetSchemas.js";
```
...
```typescript
import { GleanCore } from "@gleanwork/api-client/core.js";
import { platformAgentsCreateRun } from "@gleanwork/api-client/funcs/platformAgentsCreateRun.js";
...
async function run() {
  const res = await platformAgentsCreateRun(glean, {
    messages: [
      {
        role: "USER",
        content: [],
  ...
  if (res.ok) {
    ...
    console.log("platformAgentsCreateRun failed:", res.error);
  }
}
...
import {
  // Mutation hook for triggering the API call.
  usePlatformAgentsCreateRunMutation
} from "@gleanwork/api-client/react-query/platformAgentsCreateRun.js";
```
