...
<!-- UsageSnippet language="typescript" operationID="platform-skills-import" method="post" path="/api/skills/import" -->
```typescript
import { Glean } from "@gleanwork/api-client";
...
```typescript
import { GleanCore } from "@gleanwork/api-client/core.js";
import { skillsImport } from "@gleanwork/api-client/funcs/skillsImport.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("skillsImport failed:", res.error);
  }
}
...
import {
  // Mutation hook for triggering the API call.
  useSkillsImportMutation
} from "@gleanwork/api-client/react-query/skillsImport.js";
```
...
**Promise\<[components.PlatformSkillImportResponse](../../models/components/platformskillimportresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="platform-skills-delete" method="delete" path="/api/skills/{skill_id}" -->
```typescript
import { Glean } from "@gleanwork/api-client";
...
async function run() {
  await glean.skills.delete("{skill_id}");
...
```typescript
import { GleanCore } from "@gleanwork/api-client/core.js";
import { skillsDelete } from "@gleanwork/api-client/funcs/skillsDelete.js";
...
async function run() {
  const res = await skillsDelete(glean, "{skill_id}");
  if (res.ok) {
    const { value: result } = res;
...
import {
  // Mutation hook for triggering the API call.
  useSkillsDeleteMutation
} from "@gleanwork/api-client/react-query/skillsDelete.js";
```
...
async function run() {
  const result = await glean.skills.retrieve("{skill_id}");
...
async function run() {
  const res = await skillsRetrieve(glean, "{skill_id}");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await glean.skills.retrieveContent("{skill_id}");
...
async function run() {
  const res = await skillsRetrieveContent(glean, "{skill_id}");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
<!-- UsageSnippet language="typescript" operationID="platform-skills-sync" method="post" path="/api/skills/{skill_id}/sync" -->
```typescript
import { Glean } from "@gleanwork/api-client";
...
async function run() {
  const result = await glean.skills.sync("{skill_id}");
...
```typescript
import { GleanCore } from "@gleanwork/api-client/core.js";
import { skillsSync } from "@gleanwork/api-client/funcs/skillsSync.js";
...
async function run() {
  const res = await skillsSync(glean, "{skill_id}");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("skillsSync failed:", res.error);
  }
}
...
import {
  // Mutation hook for triggering the API call.
  useSkillsSyncMutation
} from "@gleanwork/api-client/react-query/skillsSync.js";
```
...
**Promise\<[components.PlatformSkillSyncResponse](../../models/components/platformskillsyncresponse.md)\>**
...
async function run() {
  const result = await glean.skills.listVersions("{skill_id}");
...
async function run() {
  const res = await skillsListVersions(glean, "{skill_id}");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `skillId`                                                                                                                                                                      | *string*                                                                                                                                                                       | :heavy_check_mark:                                                                                                                                                             | Glean skill ID.                                                                                                                                                                | {skill_id}                                                                                                                                                                     |
| `pageSize`                                                                                                                                                                     | *number*                                                                                                                                                                       | :heavy_minus_sign:                                                                                                                                                             | Maximum number of versions to return. Defaults to 20. Maximum is 100.                                                                                                          |                                                                                                                                                                                |
| `cursor`                                                                                                                                                                       | *string*                                                                                                                                                                       | :heavy_minus_sign:                                                                                                                                                             | Opaque pagination cursor from a previous response.                                                                                                                             |                                                                                                                                                                                |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |                                                                                                                                                                                |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |                                                                                                                                                                                |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |                                                                                                                                                                                |
...
async function run() {
  const result = await glean.skills.retrieveVersion("{skill_id}", 1);
...
async function run() {
  const res = await skillsRetrieveVersion(glean, "{skill_id}", 1);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await glean.skills.retrieveVersionContent("{skill_id}", 1);
...
async function run() {
  const res = await skillsRetrieveVersionContent(glean, "{skill_id}", 1);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
