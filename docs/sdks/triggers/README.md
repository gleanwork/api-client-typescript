...
async function run() {
  const result = await glean.triggers.get("{trigger_id}");
...
async function run() {
  const res = await triggersGet(glean, "{trigger_id}");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  await glean.triggers.delete("{trigger_id}");
...
async function run() {
  const res = await triggersDelete(glean, "{trigger_id}");
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await glean.triggers.searchEvents("{trigger_id}", {});
...
async function run() {
  const res = await triggersSearchEvents(glean, "{trigger_id}", {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await glean.triggers.getPreset("{preset_id}");
...
async function run() {
  const res = await triggersGetPreset(glean, "{preset_id}");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await glean.triggers.listPresetInputValues("{preset_id}", "{field}");
...
async function run() {
  const res = await triggersListPresetInputValues(glean, "{preset_id}", "{field}");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await glean.triggers.searchPresetEvents("{preset_id}", {
    inputs: {
      "repository": "{repository}",
    },
  });
...
async function run() {
  const res = await triggersSearchPresetEvents(glean, "{preset_id}", {
    inputs: {
      "repository": "{repository}",
    },
  });
