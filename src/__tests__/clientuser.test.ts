 ...
 * @generated-id: 77ed3fb7f313
 */

import { assert, it } from "vitest";

it.skip("Client User Addcredential", async () => {
  assert.fail(
...
it.skip("Client User Deletequeryhistory", async () => {
  assert.fail(
...
it.skip("Client User Invite", async () => {
  assert.fail(
...
it.skip("Client User Publicconfig", async () => {
  assert.fail(
...
it.skip("Client User Removecredential", async () => {
  assert.fail(
...
it.skip("Client User Support Email", async () => {
  assert.fail(
