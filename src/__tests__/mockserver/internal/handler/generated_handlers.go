...
func GeneratedHandlers(ctx context.Context, dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) []*GeneratedHandler {
	return []*GeneratedHandler{
		NewGeneratedHandler(ctx, http.MethodGet, "/rest/api/v1/actions/{actionPackId}/auth", pathGetRestAPIV1ActionsActionPackIDAuth(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPost, "/rest/api/v1/actions/{actionPackId}/auth", pathPostRestAPIV1ActionsActionPackIDAuth(dir, rt)),
