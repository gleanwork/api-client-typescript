...
func GeneratedHandlers(ctx context.Context, dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) []*GeneratedHandler {
	return []*GeneratedHandler{
		...
		NewGeneratedHandler(ctx, http.MethodGet, "/rest/api/v1/configure/datasources/{datasourceId}/instances/{instanceId}/credentialstatus", pathGetRestAPIV1ConfigureDatasourcesDatasourceIDInstancesInstanceIDCredentialstatus(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPost, "/rest/api/v1/configure/datasources/{datasourceId}/instances/{instanceId}/credentials", pathPostRestAPIV1ConfigureDatasourcesDatasourceIDInstancesInstanceIDCredentials(dir, rt)),
