 ...
 */
export function agentsCancelRun(
  client: GleanCore,
...
> {
  const input: operations.PlatformAgentsCancelRunRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.PlatformAgentsCancelRunRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.PlatformAgentRunCancellationRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/api/agents/{agent_id}/cancellations")(pathParams);
