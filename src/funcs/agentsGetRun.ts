...
> {
  const input: operations.PlatformAgentsGetRunRequest = {
    agent_id: agentId,
    run_id: runId,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.PlatformAgentsGetRunRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/agents/{agent_id}/runs/{run_id}")(pathParams);
