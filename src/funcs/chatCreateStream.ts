...
export function chatCreateStream(
  ...
  Result<
    EventStream<components.PlatformChatStreamEventServerSentEvent>,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PlatformChatCreateStreamRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/chat#stream")();
        ...
        .transform(stream => {
          return new EventStream(stream, rawEvent => {
            return {
              ...
              value: components
                .PlatformChatStreamEventServerSentEvent$inboundSchema.parse(
                  rawEvent,
                ),
            };
          });
