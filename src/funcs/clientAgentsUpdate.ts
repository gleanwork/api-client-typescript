 ...
 */
export function clientAgentsUpdate(
  client: GleanCore,
...
> {
  const input: operations.EditAgentRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.EditAgentRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.EditWorkflowRequest, {
    explode: true,
  });
