 ...
 */
export function clientChatRetrieveFile(
  client: GleanCore,
  fileId: string,
...
> {
  const input: operations.GetChatFileRequest = {
    fileId: fileId,
    preview: preview,
  };
  ...
  const parsed = safeParse(
    input,
    (value) => operations.GetChatFileRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rest/api/v1/chat-files/{fileId}")(pathParams);
