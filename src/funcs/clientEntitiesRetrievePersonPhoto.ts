...
export enum RetrievePersonPhotoAcceptEnum {
 ...
 */
export function clientEntitiesRetrievePersonPhoto(
  client: GleanCore,
  personId: string,
  ds?: string | undefined,
...
> {
  const input: operations.GetPersonPhotoRequest = {
    person_id: personId,
    ds: ds,
  };
  ...
  const parsed = safeParse(
    input,
    (value) => operations.GetPersonPhotoRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rest/api/v1/people/{person_id}/photo")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.stream(200, operations.GetPersonPhotoResponse$inboundSchema, {
      ctype: "image/png",
      hdrs: true,
      key: "Result",
    }),
