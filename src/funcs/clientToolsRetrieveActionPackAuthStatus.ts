 ...
 */
export function clientToolsRetrieveActionPackAuthStatus(
  client: GleanCore,
  actionPackId: string,
...
> {
  const input: operations.GetActionPackAuthStatusRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetActionPackAuthStatusRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ActionPackAuthStatusResponse$inboundSchema),
