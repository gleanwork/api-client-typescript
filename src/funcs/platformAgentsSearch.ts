 ...
 */
export function platformAgentsSearch(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.PlatformAgentsSearchRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/agents/search")();
