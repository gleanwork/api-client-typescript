 ...
 */
export function platformSkillsRetrieve(
  client: GleanCore,
  skillId: string,
...
> {
  const input: operations.PlatformSkillsGetRequest = {
    skill_id: skillId,
  };

  const parsed = safeParse(
    input,
    (value) => operations.PlatformSkillsGetRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.PlatformSkillGetResponse$inboundSchema),
    M.jsonErr(
