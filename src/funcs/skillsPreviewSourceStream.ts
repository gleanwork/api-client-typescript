 ...
 */
export function skillsPreviewSourceStream(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PlatformSkillsPreviewSourceStreamRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/api/skills/sources/preview#stream")();
        ...
        .transform(stream => {
          return new EventStream(stream, rawEvent => {
            return {
              ...
              value: components
                .PlatformSkillSourcePreviewStreamEventServerSentEvent$inboundSchema
                .parse(rawEvent),
            };
          });
        }),
