...
> {
  const input: operations.PlatformSkillsSyncRequest = {
    skill_id: skillId,
  };

  const parsed = safeParse(
    input,
    (value) => operations.PlatformSkillsSyncRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/skills/{skill_id}/sync")(pathParams);
