...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.PlatformSkillValidationRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/skills/validation")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.PlatformSkillValidationResponse$inboundSchema),
    M.jsonErr(
