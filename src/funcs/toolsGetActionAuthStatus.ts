 ...
 */
export function toolsGetActionAuthStatus(
  client: GleanCore,
  actionPackId: string,
...
> {
  const input: operations.GetActionAuthStatusRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetActionAuthStatusRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ActionAuthStatusResponse$inboundSchema),
