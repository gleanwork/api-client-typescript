...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.PlatformTriggerCreateRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/triggers")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.PlatformTriggerCreateResponse$inboundSchema),
    M.jsonErr(
