 ...
 */
export function troubleshootingPostApiIndexV1DebugDatasourceDocumentEvents(
  client: GleanCore,
...
> {
  const input: operations.PostApiIndexV1DebugDatasourceDocumentEventsRequest = {
  ...
  const parsed = safeParse(
    ...
    (value) =>
      operations
        .PostApiIndexV1DebugDatasourceDocumentEventsRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.DebugDocumentLifecycleRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/api/index/v1/debug/{datasource}/document/events")(
    pathParams,
  );
