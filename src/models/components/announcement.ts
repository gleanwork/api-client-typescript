 ...
 * This determines whether this is a Social Feed post or a regular announcement.
 */
export type AnnouncementChannel = OpenEnum<typeof AnnouncementChannel>;
 ...
 * This determines whether this is an external-link post or a regular announcement post. TEXT - Regular announcement that can contain rich text. LINK - Announcement that is linked to an external site.
 */
export type AnnouncementPostType = OpenEnum<typeof AnnouncementPostType>;
...
/** @internal */
export const AnnouncementChannel$inboundSchema: z.ZodType<
  AnnouncementChannel,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(AnnouncementChannel);

/** @internal */
export const AnnouncementPostType$inboundSchema: z.ZodType<
  AnnouncementPostType,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(AnnouncementPostType);
