 ...
 * The nature of the event, for example "out of office".
 */
export type AnonymousEventEventType = OpenEnum<typeof AnonymousEventEventType>;
...
/** @internal */
export const AnonymousEventEventType$inboundSchema: z.ZodType<
  AnonymousEventEventType,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(AnonymousEventEventType);
/** @internal */
export const AnonymousEventEventType$outboundSchema: z.ZodType<
  string,
  z.ZodTypeDef,
  AnonymousEventEventType
> = openEnums.outboundSchema(AnonymousEventEventType);
