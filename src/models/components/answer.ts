...
export type AnswerSourceType = OpenEnum<typeof AnswerSourceType>;
...
/** @internal */
export const AnswerSourceType$inboundSchema: z.ZodType<
  AnswerSourceType,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(AnswerSourceType);
/** @internal */
export const AnswerSourceType$outboundSchema: z.ZodType<
  string,
  z.ZodTypeDef,
  AnswerSourceType
> = openEnums.outboundSchema(AnswerSourceType);
