 ...
 * The type of this datasource. It is an important signal for relevance and must be specified and cannot be UNCATEGORIZED. Please refer to [this](https://developers.glean.com/docs/indexing_api_datasource_category/) for more details.
 */
export type DatasourceCategory = OpenEnum<typeof DatasourceCategory>;
...
export type HideBuiltInFacet = OpenEnum<typeof HideBuiltInFacet>;
 ...
 * The source from which document content was pulled, e.g. an API crawl or browser history
 */
export type CustomDatasourceConfigConnectorType = OpenEnum<
...
/** @internal */
export const DatasourceCategory$inboundSchema: z.ZodType<
  DatasourceCategory,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(DatasourceCategory);
/** @internal */
export const DatasourceCategory$outboundSchema: z.ZodType<
  string,
  z.ZodTypeDef,
  DatasourceCategory
> = openEnums.outboundSchema(DatasourceCategory);

/** @internal */
export const HideBuiltInFacet$inboundSchema: z.ZodType<
  HideBuiltInFacet,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(HideBuiltInFacet);
/** @internal */
export const HideBuiltInFacet$outboundSchema: z.ZodType<
  string,
  z.ZodTypeDef,
  HideBuiltInFacet
> = openEnums.outboundSchema(HideBuiltInFacet);

/** @internal */
export const CustomDatasourceConfigConnectorType$inboundSchema: z.ZodType<
  CustomDatasourceConfigConnectorType,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(CustomDatasourceConfigConnectorType);
/** @internal */
export const CustomDatasourceConfigConnectorType$outboundSchema: z.ZodType<
  string,
  z.ZodTypeDef,
  CustomDatasourceConfigConnectorType
> = openEnums.outboundSchema(CustomDatasourceConfigConnectorType);
