 ...
 * Status of backend generating the answer
 */
export type GeneratedQnaStatus = OpenEnum<typeof GeneratedQnaStatus>;
...
/** @internal */
export const GeneratedQnaStatus$inboundSchema: z.ZodType<
  GeneratedQnaStatus,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(GeneratedQnaStatus);
/** @internal */
export const GeneratedQnaStatus$outboundSchema: z.ZodType<
  string,
  z.ZodTypeDef,
  GeneratedQnaStatus
> = openEnums.outboundSchema(GeneratedQnaStatus);
