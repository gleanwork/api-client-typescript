...
export type ShortcutErrorErrorType = OpenEnum<typeof ShortcutErrorErrorType>;
...
/** @internal */
export const ShortcutErrorErrorType$inboundSchema: z.ZodType<
  ShortcutErrorErrorType,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(ShortcutErrorErrorType);
