 ...
 * The level of visual distinction that should be given to a result.
 */
export type Prominence = OpenEnum<typeof Prominence>;
 ...
 * Source context for this result. Possible values depend on the result type.
 */
export type StructuredResultSource = OpenEnum<typeof StructuredResultSource>;
...
/** @internal */
export const Prominence$inboundSchema: z.ZodType<
  Prominence,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(Prominence);
/** @internal */
export const Prominence$outboundSchema: z.ZodType<
  string,
  z.ZodTypeDef,
  Prominence
> = openEnums.outboundSchema(Prominence);

/** @internal */
export const StructuredResultSource$inboundSchema: z.ZodType<
  StructuredResultSource,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(StructuredResultSource);
/** @internal */
export const StructuredResultSource$outboundSchema: z.ZodType<
  string,
  z.ZodTypeDef,
  StructuredResultSource
> = openEnums.outboundSchema(StructuredResultSource);
