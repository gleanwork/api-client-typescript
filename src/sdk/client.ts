...
export class Client extends ClientSDK {
  ...
  private _datasources?: ClientDatasources;
  get datasources(): ClientDatasources {
    return (this._datasources ??= new ClientDatasources(this._options));
  }
}
